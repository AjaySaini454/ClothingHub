...
import { addToCart, removeToCart, removeSingleItem, emptyCartIteams } from '../redux/app/cartSlice'
...
const Cart = () => {
    ...
    const makePayment = async () => {
        const stripe = await loadStripe("pk_test_51OAUL3SBpye6i6eae8NlCBFswg3cIoKF2lV0PgJDaQxhDkuRXi8EjDDDmgnzEOq9cWyJCy8bnbwkxWl9XfQ2AUYg00AxQl9nDy");
        ...
        <>
            <div className='row justify-content-center m-0'>
                <div className='col-md-8 mt-5 mb-5 cardsdetails'>
                    <div className="card1">
                        <div className="card-header color-red p-3">
                            <div className='card-header-flex'>
                                <h5 className='text-white m-0'>Clothing {carts.length > 0 ? `(${carts.length})` : ""}</h5>
                                {
                                    ...
                                    <table className='table cart-table mb-0 table-responsive-sm'>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th className='text-right'><button className='btn btn-success' onClick={makePayment}>Buy Now</button></th>
                                            </tr>
